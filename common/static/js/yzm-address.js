/**
 *  YzmCMS民政部省市区三级联动行政区划数据库2020年四月版
 *  数据来自网友(冷眼看人间)整理
 *  @lastmodify		2020-06-25
 *  @site	www.yzmcms.com
 */
...
{name:'南通市', areaList:['崇川区','港闸区','通州区','如东县','启东市','如皋市','海门市','海安市']},		   
...
{name:'芜湖市', areaList:['镜湖区','弋江区','鸠江区','三山区','芜湖县','繁昌县','南陵县','无为市']},		   
...
{name:'驻马店市', areaList:['驿城区','西平县','上蔡县','平舆县','正阳县','确山县','泌阳县','汝南县','遂平县','新蔡县','济源市']}
]},
{name:'湖北省', cityList:[		   
...
{name:'襄樊市', areaList:['襄城区','樊城区','襄州区','南漳县','谷城县','保康县','老河口市','枣阳市','宜城市']},		   
...
{name:'省直辖县级行政单位', areaList:['三沙市','儋州市','五指山市','琼海市','文昌市','万宁市','东方市','定安县','屯昌县','澄迈县','临高县','白沙黎族自治县','昌江黎族自治县','乐东黎族自治县','陵水黎族自治县','保亭黎族苗族自治县','琼中黎族苗族自治县']}
]},
{name:'重庆市', cityList:[		   
...
{name:'丽江市', areaList:['古城区','玉龙纳西族自治县','永胜县','华坪县','宁蒗彝族自治县','普洱市']},		   
{name:'思茅区', areaList:['宁洱哈尼族彝族自治县','墨江哈尼族自治县','景东彝族自治县','景谷傣族彝族自治县','镇沅彝族哈尼族拉祜族自治县','江城哈尼族彝族自治县','孟连傣族拉祜族佤族自治县','澜沧拉祜族自治县','西盟佤族自治县']},		   
...
{name:'省直辖行政单位', areaList:['石河子市','阿拉尔市','图木舒克市','五家渠市','北屯市','铁门关市','双河市','可克达拉市','昆玉市','胡杨河市']}
]},
{name:'台湾省', cityList:[
